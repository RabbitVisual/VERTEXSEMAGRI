            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb" class="flex items-center gap-2 text-sm text-white/80">
                        <a href="{{ route('campo.dashboard') }}" class="hover:text-white transition-colors">Campo</a>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-12 gap-6">
        ...
        <div class="xl:col-span-8 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-700 overflow-hidden">
                ...
                <form action="{{ route('campo.profile.update') }}" method="POST" enctype="multipart/form-data" id="profileForm">
                    <div class="p-6">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4 p-6 bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-700">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('campo.dashboard') }}" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 focus:ring-4 focus:ring-gray-300 dark:bg-slate-700 dark:text-gray-300 dark:hover:bg-slate-600 dark:focus:ring-slate-600 transition-all">
