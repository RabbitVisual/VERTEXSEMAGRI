    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 md:pb-6 border-b border-gray-200 dark:border-slate-700">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3 mb-2">
                ...
                <span>Programas de Agricultura</span>
            ...
            <nav aria-label="breadcrumb" class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <span class="text-gray-900 dark:text-white font-medium">Programas</span>
            </nav>
        </div>
                ...
                <tbody class="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                        ...
                        <td class="px-4 md:px-6 py-4 hidden sm:table-cell">
                            <div class="text-sm text-gray-600 dark:text-gray-400 truncate max-w-xs">{{ Str::limit($programa->descricao ?? '', 50) }}</div>
                        </td>
                        ...
                        <td class="px-4 md:px-6 py-4 whitespace-nowrap text-right">
                            <a href="{{ route('consulta.programas.show', $programa->id) }}" class="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-900/50 transition-colors" title="Ver detalhes">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
