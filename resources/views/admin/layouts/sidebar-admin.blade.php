    ...
    <div class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <a href="{{ route('admin.homepage.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.homepage.*') ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
            <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.homepage.*') ? 'bg-emerald-500 dark:bg-emerald-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                <x-module-icon module="Homepage" class="w-5 h-5 {{ request()->routeIs('admin.homepage.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
            </div>
        ...
        <a href="{{ route('admin.blog.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.blog.*') ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
            <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.blog.*') ? 'bg-emerald-500 dark:bg-emerald-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                <x-module-icon module="Blog" class="w-5 h-5 {{ request()->routeIs('admin.blog.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
            </div>
        ...
        <a href="{{ route('admin.avisos.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.avisos.*') ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
            <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.avisos.*') ? 'bg-emerald-500 dark:bg-emerald-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                <x-module-icon module="Avisos" class="w-5 h-5 {{ request()->routeIs('admin.avisos.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
            </div>
        ...
        <a href="{{ route('admin.carousel.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.carousel.*') ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
            <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.carousel.*') ? 'bg-emerald-500 dark:bg-emerald-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                <x-icon name="images" class="w-5 h-5 {{ request()->routeIs('admin.carousel.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
            </div>
        ...
        <div class="pt-4 mt-4 border-t border-gray-200 dark:border-slate-700">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.demandas.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.demandas.*') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.demandas.*') ? 'bg-blue-500 dark:bg-blue-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                ...
                <a href="{{ route('admin.localidades.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.localidades.*') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.localidades.*') ? 'bg-blue-500 dark:bg-blue-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                ...
                <a href="{{ route('admin.pessoas.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.pessoas.*') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.pessoas.*') ? 'bg-blue-500 dark:bg-blue-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                ...
                @if(Route::has('admin.lideres-comunidade.index'))
                ...
                @if(Route::has('admin.formularios.demanda'))
                <div x-data="{ open: {{ request()->routeIs('admin.formularios.*') ? 'true' : 'false' }} }" class="space-y-1">
                    <button @click="open = !open" class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.formularios.*') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                        <div class="flex items-center gap-3">
                            <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.formularios.*') ? 'bg-blue-500 dark:bg-blue-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                                <x-icon name="file-pen" class="w-5 h-5 {{ request()->routeIs('admin.formularios.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                            </div>
                            <span class="flex-1 text-left">Formulários Manuais</span>
                        </div>
                    ...
                    <div x-show="open" x-collapse class="pl-14 space-y-1">
                        <a href="{{ route('admin.formularios.demanda') }}" target="_blank" class="block px-3 py-2 rounded-lg text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                             Ficha de Demanda
                        </a>
                        <a href="{{ route('admin.formularios.ordem') }}" target="_blank" class="block px-3 py-2 rounded-lg text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                             Ficha de Ordem
                        </a>
                    </div>
                </div>
        ...
        <div class="pt-4 mt-4 border-t border-gray-200 dark:border-slate-700">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.pocos.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.pocos.*') ? 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.pocos.*') ? 'bg-cyan-500 dark:bg-cyan-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                ...
                <a href="{{ route('admin.estradas.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.estradas.*') ? 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.estradas.*') ? 'bg-amber-500 dark:bg-amber-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-module-icon module="Estradas" class="w-5 h-5 {{ request()->routeIs('admin.estradas.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.funcionarios.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.funcionarios.*') ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.funcionarios.*') ? 'bg-indigo-500 dark:bg-indigo-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-module-icon module="Funcionarios" class="w-5 h-5 {{ request()->routeIs('admin.funcionarios.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.equipes.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.equipes.*') ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.equipes.*') ? 'bg-indigo-500 dark:bg-indigo-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-module-icon module="Equipes" class="w-5 h-5 {{ request()->routeIs('admin.equipes.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.materiais.solicitar.create') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.materiais.solicitar.*') ? 'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.materiais.solicitar.*') ? 'bg-teal-500 dark:bg-teal-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="file-lines" class="w-5 h-5 {{ request()->routeIs('admin.materiais.solicitar.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.materiais.solicitacoes.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.materiais.solicitacoes.*') ? 'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.materiais.solicitacoes.*') ? 'bg-teal-500 dark:bg-teal-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="file-invoice" class="w-5 h-5 {{ request()->routeIs('admin.materiais.solicitacoes.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.materiais.categorias.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.materiais.categorias.*') ? 'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.materiais.categorias.*') ? 'bg-teal-500 dark:bg-teal-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="grid-2" class="w-5 h-5 {{ request()->routeIs('admin.materiais.categorias.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
        ...
        <div class="pt-4 mt-4 border-t border-gray-200 dark:border-slate-700">
            ...
            <div class="space-y-1">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.caf.*') || request()->routeIs('caf.cadastrador.*') ? 'true' : 'false' }} }" class="space-y-1">
                    <button @click="open = !open" class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.caf.*') || request()->routeIs('caf.cadastrador.*') ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                        <div class="flex items-center gap-3">
                            <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.caf.*') || request()->routeIs('caf.cadastrador.*') ? 'bg-emerald-500 dark:bg-emerald-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                                <x-module-icon module="CAF" class="w-5 h-5 {{ request()->routeIs('admin.caf.*') || request()->routeIs('caf.cadastrador.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                            </div>
                            <span class="flex-1 text-left">Módulo CAF</span>
                        </div>
                        <x-icon name="chevron-down" class="w-4 h-4 transition-transform" x-bind:class="{ 'rotate-180': open }" style="duotone" />
                    </button>
                    <div x-show="open" x-collapse class="pl-14 space-y-1">
                        @if(Route::has('caf.cadastrador.index'))
                        <a href="{{ route('caf.cadastrador.index') }}" class="block px-3 py-2 rounded-lg text-sm {{ request()->routeIs('caf.cadastrador.*') ? 'text-emerald-700 dark:text-emerald-400 font-medium' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                             Novos Cadastros
                        </a>
                        @endif
                        @if(Route::has('admin.caf.index'))
                        <a href="{{ route('admin.caf.index') }}" class="block px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.caf.*') ? 'text-emerald-700 dark:text-emerald-400 font-medium' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('admin.chat.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.chat.*') ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.chat.*') ? 'bg-blue-500 dark:bg-blue-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-module-icon module="Chat" class="w-5 h-5 {{ request()->routeIs('admin.chat.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.audit.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.audit.*') ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.audit.*') ? 'bg-red-500 dark:bg-red-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="file-shield" class="w-5 h-5 {{ request()->routeIs('admin.audit.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('relatorios.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('relatorios.*') ? 'bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('relatorios.*') ? 'bg-pink-500 dark:bg-pink-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-module-icon module="Relatorios" class="w-5 h-5 {{ request()->routeIs('relatorios.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.users.*') ? 'bg-emerald-500 dark:bg-emerald-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="users" class="w-5 h-5 {{ request()->routeIs('admin.users.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.modules.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.modules.*') ? 'bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.modules.*') ? 'bg-violet-500 dark:bg-violet-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="cubes" class="w-5 h-5 {{ request()->routeIs('admin.modules.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.config.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.config.*') ? 'bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-slate-300' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.config.*') ? 'bg-slate-500 dark:bg-slate-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="gear" class="w-5 h-5 {{ request()->routeIs('admin.config.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? 'true' : 'false' }} }" class="space-y-1">
                    <button @click="open = !open" class="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? 'bg-slate-100 text-slate-700 dark:bg-slate-700 dark:text-slate-300' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                        <div class="flex items-center gap-3">
                            <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? 'bg-slate-500 dark:bg-slate-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                                <x-icon name="shield-halved" class="w-5 h-5 {{ request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                            </div>
                            <span class="flex-1 text-left">Controle de Acesso</span>
                        </div>
                        <x-icon name="chevron-down" class="w-4 h-4 transition-transform" x-bind:class="{ 'rotate-180': open }" style="duotone" />
                    </button>
                    <div x-show="open" x-collapse class="pl-14 space-y-1">
                        <a href="{{ route('admin.roles.index') }}" class="block px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.roles.*') ? 'text-slate-700 dark:text-slate-400 font-medium' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                             Funções (Roles)
                        </a>
                        <a href="{{ route('admin.permissions.index') }}" class="block px-3 py-2 rounded-lg text-sm {{ request()->routeIs('admin.permissions.*') ? 'text-slate-700 dark:text-slate-400 font-medium' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                             Permissões
                        </a>
                    </div>
                </div>
                ...
                <a href="{{ route('admin.api.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.api.*') ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.api.*') ? 'bg-indigo-500 dark:bg-indigo-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="code" class="w-5 h-5 {{ request()->routeIs('admin.api.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.backup.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.backup.*') ? 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.backup.*') ? 'bg-cyan-500 dark:bg-cyan-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="database" class="w-5 h-5 {{ request()->routeIs('admin.backup.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
                ...
                <a href="{{ route('admin.updates.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-200 {{ request()->routeIs('admin.updates.*') ? 'bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-400' : 'text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700' }}">
                    <div class="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center {{ request()->routeIs('admin.updates.*') ? 'bg-indigo-500 dark:bg-indigo-600' : 'bg-gray-100 dark:bg-slate-700' }}">
                        <x-icon name="arrow-up-from-bracket" class="w-5 h-5 {{ request()->routeIs('admin.updates.*') ? 'text-white' : 'text-gray-600 dark:text-gray-400' }}" style="duotone" />
                    </div>
