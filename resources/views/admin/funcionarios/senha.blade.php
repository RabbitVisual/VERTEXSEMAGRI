...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-6 border-b border-gray-200 dark:border-slate-700">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Configure as credenciais de acesso para <strong>{{ $funcionario->nome }}</strong>.</p>
        </div>
        <a href="{{ route('admin.funcionarios.show', $funcionario->id) }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors dark:bg-slate-800 dark:text-gray-300 dark:border-slate-600 dark:hover:bg-slate-700">
