    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 md:pb-6 border-b border-gray-200 dark:border-slate-700">
        <div>
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white flex items-center gap-3 mb-2">
                ...
                <span>Editar Slide do Carousel</span>
            </h1>
            ...
            <div class="p-6 md:p-8 space-y-6 md:space-y-8">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        @if($carousel->image)
                            <div class="mb-4">
                                <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Imagem Atual:</p>
                                <img src="{{ asset('storage/' . $carousel->image) }}" alt="{{ $carousel->title ?? 'Slide' }}" class="w-full max-w-md h-64 object-cover rounded-lg border border-gray-200 dark:border-slate-700">
                            </div>
                        @endif
                        <input type="file"
                               id="image"
                        ...
                        @enderror
                        <p class="text-xs text-gray-500 dark:text-gray-400">Deixe em branco para manter a imagem atual</p>
                        <div id="imagePreview" class="hidden">
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Nova Imagem:</p>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               id="link_text"
                               name="link_text"
                               value="{{ old('link_text', $carousel->link_text ?? 'Saiba mais') }}"
