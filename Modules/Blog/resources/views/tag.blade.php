...
@section('title', 'Tag: ' . $tag->name . ' - Blog VERTEXSEMAGRI')
@section('meta_description', 'Artigos com a tag ' . $tag->name . ' no blog oficial da Secretaria Municipal de Agricultura')
@section('meta_keywords', $tag->name . ', blog, noticias, secretaria agricultura')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <nav class="flex mb-8" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li><span class="text-gray-300 dark:text-gray-600">/</span></li>
            <li><span class="text-emerald-600 dark:text-emerald-400 font-medium">Tag: {{ $tag->name }}</span></li>
        </ol>
    </nav>
    ...
    <div class="text-center mb-12">
        ...
        <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Artigos marcados com a tag "{{ $tag->name }}"
        </p>
    </div>
    ...
    @else
        ...
        <div class="text-center py-12">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-6">Não há artigos publicados com esta tag ainda.</p>
