...
<body>
    ...
    <div class="header">
        ...
        <div style="width: 60px; height: 60px; background: #ddd; border-radius: 50%; margin: 0 auto 10px auto; display: flex; items-center; justify-content: center; font-size: 10px; color: #666; line-height: 60px;">BRASÃO</div>
    ...
    <div class="content-body">
        ...
        @empty
        <div class="post" style="text-align: center; color: #666; column-span: all;">
