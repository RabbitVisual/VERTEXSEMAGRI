                ...
                <div class="flex items-center gap-6">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <span class="text-xs font-bold text-slate-400 uppercase tracking-widest">Protocolo de Demanda</span>
                        </div>
                        <h1 class="text-3xl md:text-4xl font-black text-white tracking-tight">
                            Abrir Nova <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-400">Demanda</span>
                        </h1>
                    </div>
                </div>
            ...
            <x-demandas::card class="mb-6 overflow-hidden">
                <x-slot name="header">
                    <div class="flex items-center gap-3">
                        ...
                        <h3 class="text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider">
                            Dados do Solicitante e Demanda
                        </h3>
                    </div>
                </x-slot>
                ...
                <form action="{{ route('demandas.store') }}" method="POST" id="demandaForm" class="space-y-6">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 border-t border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 -mx-6 -mb-6 px-6 py-5">
                        <x-demandas::button href="{{ route('demandas.index') }}" variant="secondary" size="lg">
                            <x-icon name="xmark" class="w-4 h-4 mr-2" />
                            Cancelar
                        </x-demandas::button>
                        <x-demandas::button type="submit" id="submitBtn" variant="primary" size="lg" class="shadow-xl border-b-4 border-indigo-700 active:border-b-0 active:translate-y-1 transition-all">
                            <x-icon name="circle-check" class="w-4 h-4 mr-2" />
                            <span id="submitText">Finalizar e Salvar</span>
                            <span id="submitLoading" class="hidden">
                                <x-icon name="circle-notch" class="animate-spin -ml-1 mr-2 h-4 w-4" />
                                Processando...
                            </span>
                        </x-demandas::button>
                    </div>
