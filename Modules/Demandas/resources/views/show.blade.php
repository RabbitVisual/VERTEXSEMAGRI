                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ $demanda->total_interessados ?? 1 }} pessoa(s) vinculada(s) a esta demanda
                                    </p>
                                </div>
                            </div>
                            <a href="{{ route('demandas.interessados', $demanda->id) }}" class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg transition-colors">
                    ...
                    <div>
                        ...
                        @else
                            <div class="text-center py-6">
                                <svg class="w-12 h-12 text-gray-300 dark:text-gray-600 mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
