...
@section('title', 'Novo Evento - Agricultura')
...
<div class="max-w-4xl">
    <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden">
        <form action="{{ route('co-admin.eventos.store') }}" method="POST" class="p-6 md:p-8">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="titulo" id="titulo" value="{{ old('titulo') }}" required
                               ...
                               placeholder="Ex: Curso de Capacitação em Hidroponia">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="descricao" id="descricao" rows="4"
                                  ...
                                  placeholder="Detalhes sobre o evento, palestrantes, pré-requisitos...">{{ old('descricao') }}</textarea>
                    ...
                    <div>
                        ...
                        <select name="tipo" id="tipo" required
                            ...
                            <option value="capacitacao" {{ old('tipo') == 'capacitacao' ? 'selected' : '' }}>Capacitação/Curso</option>
                            <option value="palestra" {{ old('tipo') == 'palestra' ? 'selected' : '' }}>Palestra</option>
                            <option value="feira" {{ old('tipo') == 'feira' ? 'selected' : '' }}>Feira/Exposição</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="endereco" id="endereco" value="{{ old('endereco') }}"
                               class="block w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                               placeholder="Ex: Galpão da Cooperativa, Sala 02">
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="data_fim" id="data_fim" value="{{ old('data_fim') }}"
                               class="block w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all">
                    ...
                    <div>
                        ...
                        <input type="number" name="vagas_totais" id="vagas_totais" value="{{ old('vagas_totais', 0) }}" min="0"
                               class="block w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="inscricao_aberta" value="1" class="sr-only peer" {{ old('inscricao_aberta', true) ? 'checked' : '' }}>
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-300 dark:peer-focus:ring-indigo-800 rounded-full peer dark:bg-slate-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-indigo-600"></div>
