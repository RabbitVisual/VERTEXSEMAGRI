...
@section('title', 'Criar Evento - Admin')
...
<div class="space-y-6 md:space-y-8">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700">
        ...
        <form action="{{ route('admin.eventos.store') }}" method="POST" class="p-6">
            @csrf
            @php $evento = null; @endphp
            @include('programasagricultura::admin.eventos._form', ['evento' => null, 'localidades' => $localidades])
        </form>
    </div>
</div>
@endsection
