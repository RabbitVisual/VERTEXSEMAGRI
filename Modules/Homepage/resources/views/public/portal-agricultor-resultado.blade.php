    ...
    <div class="container mx-auto px-4">
        ...
        @if($pessoa)
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 mb-6">
                <h2 class="text-xl font-bold font-poppins text-gray-900 dark:text-white mb-4">Dados Cadastrais</h2>
        ...
        <div class="mb-6">
            <h2 class="text-2xl font-bold font-poppins text-gray-900 dark:text-white mb-4">
                Programas e Benefícios
            </h2>
