...
<div class="space-y-8 animate-fade-in pb-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-8">
            ...
            <form action="{{ route('co-admin.iluminacao.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="flex items-center justify-end gap-4 p-8 bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700/50 shadow-sm">
                    <x-iluminacao::button href="{{ route('co-admin.iluminacao.index') }}" variant="outline" size="lg">
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <x-iluminacao::card header="Atalhos Rápidos">
                <div class="space-y-3">
                    ...
                    <a href="{{ route('co-admin.iluminacao.index') }}" class="flex items-center justify-between p-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors group">
                        <div class="flex items-center gap-3">
