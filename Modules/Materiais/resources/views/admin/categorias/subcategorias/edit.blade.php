    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 md:pb-6 border-b border-gray-200 dark:border-slate-700">
        <div>
            <h1 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white flex items-center gap-3 mb-2">
                ...
                <span>Editar Subcategoria: {{ $subcategoria->nome }}</span>
            </h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="text" id="nome" name="nome" value="{{ old('nome', $subcategoria->nome) }}" required
                        ...
                        placeholder="Ex: Lâmpadas LED, Tubos PVC, Cabos...">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="descricao" name="descricao" rows="4"
                        class="bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full p-3 dark:bg-slate-900 dark:border-slate-700 dark:placeholder-gray-500 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500 transition-all"
                        placeholder="Descreva o propósito desta subcategoria...">{{ old('descricao', $subcategoria->descricao) }}</textarea>
                </div>
                ...
                <div class="flex items-center space-x-3 pt-8">
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Subcategoria Ativa</span>
                    </label>
                </div>
            </div>

            <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-100 dark:border-slate-700">
                <a href="{{ route('admin.materiais.categorias.subcategorias.index', $categoria->id) }}" class="px-6 py-3 text-sm font-bold text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 dark:bg-slate-700 dark:text-gray-300 dark:hover:bg-slate-600 transition-all">
                    Cancelar
                </a>
