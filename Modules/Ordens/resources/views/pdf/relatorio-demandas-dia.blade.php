...
<head>
    <meta charset="utf-8">
    <title>Relatório de Demandas do Dia</title>
    <style>
...
<body>
    <div class="header">
        <div class="title">Relatório de Demandas do Dia</div>
        <div class="date">Data: {{ \Carbon\Carbon::parse($data)->format('d/m/Y') }}</div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ ucfirst(str_replace('_', ' ', $demanda->status)) }}</td>
            </tr>
            @empty
            <tr>
                <td colspan="6" style="text-align: center;">Nenhuma demanda registrada para esta data.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
