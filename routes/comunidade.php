...
/*
|--------------------------------------------------------------------------
| Rotas da Comunidade (Módulo Poços)
|--------------------------------------------------------------------------
|
| Este arquivo gerencia as rotas para Líderes de Comunidade e Moradores.
| Todo o acesso depende do módulo 'Pocos' estar ativo.
|
*/
...
if (Module::isEnabled('Pocos')) {
    ...
    // =========================================================================
    // Área do Líder de Comunidade (Authenticated)
    // =========================================================================
    ...
    Route::prefix('lider-comunidade')->name('lider-comunidade.')->middleware(['auth', 'role:lider-comunidade'])->group(function () {
        ...
        // Solicitações de Baixa (Comprovantes enviados por moradores)
    ...
    // =========================================================================
    // Área do Morador (Public Access & Authenticated)
    // =========================================================================

    Route::prefix('morador-poco')->name('morador-poco.')->group(function () {

        // ---------------------------------------------------------------------
        // Acesso Público (Login)
        // ---------------------------------------------------------------------
